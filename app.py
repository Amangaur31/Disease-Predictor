...
def predicth():
    ...
    if(int_f[0]=='1'):
        ...
        model = pickle.load(open('DiseasePred-master\heartKNN.pkl', 'rb'))
    elif(int_f[0]=='2'):
        int_f[0]="Random Forest Classifier"
        model = pickle.load(open('DiseasePred-master\heartRFC.pkl', 'rb'))
    elif(int_f[0]=='3'):
        int_f[0]="Naive Bayes Classifier"
        model = pickle.load(open('DiseasePred-master\heartGNB.pkl', 'rb'))
    temp_f=int_f[1:]
...
def predict():
    ...
    if(int_f[0]=='1'):
        int_f[0]="KNN Classifier"
        model = pickle.load(open('DiseasePred-master\ILPDKNN.pkl', 'rb'))
    elif(int_f[0]=='2'):
        int_f[0]="Random Forest Classifier"
        model = pickle.load(open('DiseasePred-master\ILPDrfc.pkl', 'rb'))
...
def predCovid():
    ...
    if(int_f[0]=='1'):
        int_f[0]="Random Forest Classifier"
        model = pickle.load(open('DiseasePred-master\covidRFC.pkl', 'rb'))
    elif(int_f[0]=='2'):
        int_f[0]="Decision"
        model = pickle.load(open('DiseasePred-master\covidTree.pkl', 'rb'))
    elif(int_f[0]=='3'):
        int_f[0]="KNN classfier"
        model = pickle.load(open('DiseasePred-master\covidKNN.pkl', 'rb'))
    temp_f=int_f[1:]
    temp_f=[float(x) for x in temp_f]
    final_features = [temp_f]
    prediction = model.predict(final_features)
